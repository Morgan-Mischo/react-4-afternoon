    ...
    return (
      <div>
        <div className='subnav'>
          <h3><Link to="/about" className='subnav'>About</Link></h3>
          <h3><Link to="/about/history" className='subnav'>History</Link></h3>
          <h3><Link to="/about/contact" className='subnav'>Contact</Link> </h3>
        </div>
        <div className='box'>
          <Switch>
